    ...
    return {
        ...
        "steps": [
            ...
            step(
                ...
                "submit_k8s_job",
                "Creates the Job on the k3s cluster (from kilvin-py/infra/docker-compose.yml) in the kilvin-training namespace.",
                [
                    "Returns the generated Kubernetes job name and UID that the workflow records for operators.",
            ...
            step(
                ...
                [
                    "Polls Job conditions and pod logs with heartbeats, so cancellation has a checkpoint to land on while the pod is running.",
                    "Log pointers are persisted as logs.yaml before the failure check, the allocation is released, and a failed final status raises and fails the stage.",
                ],
