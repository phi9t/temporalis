...
def ref(repo_root: Path, repos, repo_id: str, path: str, symbol: str, label: str) -> dict[str, Any]:
    repo = repos[repo_id]
    return {
        "repo": repo_id,
        "label": label,
...
def local_ref(repo_root: Path, path: str, symbol: str, label: str) -> dict[str, Any]:
    return {
        "repo": "kilvin",
        "label": label,
        "path": path,
