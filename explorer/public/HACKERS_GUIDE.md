...
- User-level event: a workflow schedules a side-effecting activity such as resource allocation or training monitoring, then awaits its result. Activity code can touch external systems; workflow code cannot.
